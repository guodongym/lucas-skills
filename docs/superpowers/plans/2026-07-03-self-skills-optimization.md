...
- [ ] **Step 1: 写失败测试（追加到 test_inspect_history.py 的 InspectHistoryTest 类内）**
...
- [ ] **Step 1: 替换 SKILL.md Step 5（125-135 行整节）**
...
- [ ] **Step 1: output-template.md 末尾追加校准节**
...
- [ ] **Step 3: 重命名特殊字符文件并更新 index.local.md**
...
- [ ] **Step 1: Grounding Steps 第 1 条扩展（60 行）**
...
- [ ] **Step 2: Output Shape 默认模板的 定位/当前状态 区块（87-110 行）**
...
- [ ] **Step 4: execute-from-plan 定位块与 spec 启发式（156-169 行）**
...
- [ ] **Step 5: stop conditions 具象化（161 行）**
...
- [ ] **Step 6: continue-from-context 的 定位 区块同步加快照字段（253-257 行）**
...
- [ ] **Step 1: 在 macOS 应用探测循环之后、报错分支之前插入**
...
- [ ] **Step 1: SKILL.md Step 3 开头改为模板起步**
...
- [ ] **Step 2: SKILL.md Step 5 加脚本预检与 PNG 回读自检**
