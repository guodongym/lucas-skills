...
```bash
uv run --python '>=3.11' --with pyyaml python3 skill_manager.py set docx --tool codex --on --json
```
...
```bash
uv run --python '>=3.11' --with pyyaml python3 skill_manager.py adopt --apply --json
```
